...
<form class="form-horizontal" role="form">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="goodInput" placeholder="商品名称" class="col-xs-10 col-sm-5"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="goodStatusInput" placeholder="类型:店铺首页 热销 两者之一" class="col-xs-10 col-sm-5"/>
...
<script>
    $("#submitGood").click(function () {
        ...
        $.ajax({
            url: "/adminUser/queryShopGoodByName?goodName=" + $("#goodInput").val(),
            success: function (res) {
                ...
                for (var i = 0; i < dataArray.length; i++) {
                    ...
                    console.log(data)
                    $("#manageGoodBody").append("<tr><td>" + data.name + "</td><td>" + data.classifyName + "</td><td>" + data.statusString + "</td><td>" + data.shopName + "</td><td><button class=\"btn btn-success\" onclick=\"updateGoodStatus(" + data.id + ",'shopMainPage')\" >设置店铺首页</button></td><td><button class=\"btn btn-success\" onclick=\"updateGoodStatus(" + data.id + ",'hotSale')\" >设置热销商品</button></td></tr>")
                }
            }
        })
    })
    $("#goodStatusSubmit").click(function () {
        $("#manageGoodBody").children("tr").remove()
        $.ajax({
            url: "/adminUser/queryShopGoodByStatus",
            data: {
...
<script>
    $("#manageShopGood").addClass("active");
